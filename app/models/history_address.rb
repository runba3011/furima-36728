class HistoryAddress
  ...
  def save
    ...
    Address.create(post_number: post_number , prefecture_id: prefecture_id , city: city , building_number: building_number , phone_number: phone_number , building_name: building_name , history_id: history.id) 
    bunding.pry
